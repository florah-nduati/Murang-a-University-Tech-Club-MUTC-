...
const testimonies = [
  ...
  },
  {
    ...
    text: "The club's machine learning track helped me secure my first internship. The projects we worked on were practical and prepared me for real-world challenges.",
  },
  {
    alumniAvater: alumni3,
    alumniName: "Jane Njeri",
    title: "UI/UX Designer and Alumni",
    text: "I was able to build a solid portfolio by participating in UI/UX design sessions. The mentorship was invaluable and opened doors to opportunities I never imagined.",
  },
  {
    alumniAvater: alumni4,
    alumniName: "George Mwangi",
    title: "Cloud Engineer and Alumni",
    text: "The cloud engineering track introduced me to AWS and Azure. The hands-on experience I gained from the club has been critical in my professional journey.",
  },
  {
  ...
  },
  {
    ...
    text: "The cybersecurity track was a game changer for me. It gave me hands-on experience in ethical hacking, which helped me land a security analyst position.",
  },
  {
  ...
  },
  {
    ...
    text: "The comprehensive sessions on web development gave me the confidence to build full-stack applications. MUTC gave me the skills and support I needed.",
  },
];
